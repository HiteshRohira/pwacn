...
export const components: Record<string, { file: string; dependencies: string[] }> = {
  ...
  'mobile-list': { file: 'mobile-list.tsx', dependencies: ['pressable'] },
  'mobile-screen': { file: 'mobile-screen.tsx', dependencies: [] },
  'surface-theme': { file: 'surface-theme.tsx', dependencies: [] },
